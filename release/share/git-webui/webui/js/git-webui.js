...
webui.SideBarView = function(mainView) {
    ...
    self.element = $(   '<div id="sidebar">' +
                            ...
                            '<div id="sidebar-content">' +
                                '<section id="sidebar-gitthereum">'+
                                    '<h4>Gitthereum</h4>'+
                                    '<ul>'+
                                    '<li id="sidebar-check-balance" class="sidebar-ref">Check balance</li>'+
                                    '<li id="sidebar-transfer" class="sidebar-ref">Transfer</li>'+
                                    '</ul>'+
                                '</section>'+
    ...
    var checkBalanceElement = $('#sidebar-check-balance', self.element)
    checkBalanceElement.click(function(event) {
        $("*", self.element).removeClass("active")
        checkBalanceElement.addClass('active')
        self.mainView.transferView.update('check-balance')
    })

    var transferElement = $('#sidebar-transfer', self.element)
    transferElement.click(function(event) {
        $("*", self.element).removeClass("active")
        transferElement.addClass('active')
        self.mainView.transferView.update('transfer')
    })
...
webui.TransferView = function(mainView) {
    ...
    self.checkBalance = $('#check-balance', self.element)
    self.transfer = $('#transfer', self.element)
    ...
    self.checkBalanceButton = $('#check-balance-button', self.element)
